...
public class DAO {
	...
	private static String CADASTRAR_CLIENTE = " INSERT INTO CLIENTE "
			+ " (ID, NOME, CPFCNPJ, EMAIL, TELEFONE, ENDEREÇO ) " + "VALUES(NULL,?,?,?,?,?)";
	...
	private static String CADASTRAR_USUARIO = " INSERT INTO USUARIO " + " (NOMEdeUSUARIO,SENHA ) " + "VALUES(?,?)";
	...
	public Usuario consultarUsuario(String nomeUsuario, String senha) throws Exception {
		...
		try {
			...
			while (resultSet.next()) {
				usuario = new Usuario(resultSet.getString("NomeUSUARIO"), resultSet.getString("SENHA"));
